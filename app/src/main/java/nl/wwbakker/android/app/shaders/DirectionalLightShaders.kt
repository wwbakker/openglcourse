...
object DirectionalLightShaders {
    ...
    private val uDiffuseLightLocation = ShaderVariable(UniformVertexShader, "vec3", "uDiffuseLightLocation")
    private val uDiffuseColor = ShaderVariable(UniformVertexShader, "vec4", "uDiffuseColor")
    ...
    private val uAmbientColor = ShaderVariable(UniformVertexShader, "vec4", "uAmbientColor")
    private val vAmbientColor = ShaderVariable(Varying, "vec4", "vAmbientColor")
    private val uSpecularColor = ShaderVariable(UniformVertexShader, "vec4", "uSpecularColor")
    ...
    private val uSpecularLightLocation = ShaderVariable(UniformVertexShader, "vec3", "uSpecularLightLocation")
